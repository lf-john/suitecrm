...
class LF_WeeklyPlanViewPlanning extends SugarView
{
    ...
    public function display()
    {
        ...
        // Add Closed Won at the end
        $stageOrder[] = 'Closed Won';
        ...
        foreach ($pipelineOpps as $opp) {
            ...
            echo '<td><a href="index.php?module=Opportunities&action=DetailView&record=' . htmlspecialchars($oppId) . '">' . htmlspecialchars($opp['name']) . '</a></td>';
