    ...
    if ($view == 'EditView') {
        ...
        while ($row = $focus->db->fetchByAssoc($result)) {
            ...
            if ($enable_groups && ($group_id != $row['group_id'] || $i == 0)) {
                ...
                $groupEnd .= "<td class='tabDetailViewDL' style='text-align: right;padding:2px;'>".currency_format_number($group_item->total_amt ?? 0, $params)."</td>";
                $groupEnd .= "</tr>";
                $groupEnd .= "<tr>";
                ...
                $groupEnd .= "<td class='tabDetailViewDL' style='text-align: right;padding:2px;'>".currency_format_number($group_item->discount_amount ?? 0, $params)."</td>";
                $groupEnd .= "</tr>";
                $groupEnd .= "<tr>";
                ...
                $groupEnd .= "<td class='tabDetailViewDL' style='text-align: right;padding:2px;'>".currency_format_number($group_item->tax_amount ?? 0, $params)."</td>";
                $groupEnd .= "</tr>";
                $groupEnd .= "<tr>";
