...
$defaultConfigEntries = array(
    ...
    array('stages', 'stage_order', '["2-Analysis (0%)","3-Confirmation (10%)","5-Specifications (30%)","6-Solution (60%)","7-Closing (90%)","closed_won"]', 'Stage order'),
    array('stages', 'stage_probabilities', '{"2-Analysis (0%)":0,"3-Confirmation (10%)":10,"5-Specifications (30%)":30,"6-Solution (60%)":60,"7-Closing (90%)":90,"closed_won":100}', 'Stage to probability mapping'),
    ...
    array('stages', 'analysis_stage', '2-Analysis (0%)', 'Stage excluded from pipeline'),
