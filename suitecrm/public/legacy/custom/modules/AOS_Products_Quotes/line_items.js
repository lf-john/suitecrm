...
function insertProductLine(tableid, groupid) {
  ...
  // VAT column removed - hidden fields for compatibility
  var vatCompat = document.createElement('span');
  vatCompat.style.display = 'none';
  vatCompat.innerHTML = "<input type='hidden' name='product_vat_amt[" + prodln + "]' id='product_vat_amt" + prodln + "' value='0.00'>";
  vatCompat.innerHTML += "<input type='hidden' name='product_vat[" + prodln + "]' id='product_vat" + prodln + "' value='0'>";
  x.appendChild(vatCompat);
  ...
  h1.innerHTML += "<textarea tabindex='116' name='product_item_description[" + prodln + "]' id='product_item_description" + prodln + "' rows='3' style='width:calc(100% - 100px)' class='product_item_description'></textarea>&nbsp;&nbsp;";
  ...
  i.innerHTML += "<textarea tabindex='116' name='product_description[" + prodln + "]' id='product_description" + prodln + "' rows='3' style='width:95%' class='product_description'></textarea>&nbsp;&nbsp;"
...
function insertServiceLine(tableid, groupid) {
  ...
  // VAT column removed - hidden fields for compatibility
  var svcVatCompat = document.createElement('span');
  svcVatCompat.style.display = 'none';
  svcVatCompat.innerHTML = "<input type='hidden' name='service_vat_amt[" + servln + "]' id='service_vat_amt" + servln + "' value='0.00'>";
  svcVatCompat.innerHTML += "<input type='hidden' name='service_vat[" + servln + "]' id='service_vat" + servln + "' value='0'>";
  x.appendChild(svcVatCompat);
...
function calculateTotal(key)
{
  ...
  for (i=0; i < length; i++) {
    ...
    if (product_vat_amt !== 0 && deleted != 1) {
      // tax += product_vat_amt; // VAT disabled
    }
  }
