...
export declare const emailValidator: (formatter: EmailFormatter) => StandardValidatorFn;
export declare class EmailValidator implements ValidatorInterface {
    protected formatter: EmailFormatter;
    constructor(formatter: EmailFormatter);
    ...
    static ɵprov: i0.ɵɵInjectableDeclaration<EmailValidator>;
}
