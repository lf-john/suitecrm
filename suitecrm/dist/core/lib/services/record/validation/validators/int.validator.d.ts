...
export declare const intValidator: (formatter: NumberFormatter) => StandardValidatorFn;
export declare class IntValidator implements ValidatorInterface {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<IntValidator, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<IntValidator>;
}
