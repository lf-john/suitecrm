...
export declare const floatValidator: (formatter: NumberFormatter) => StandardValidatorFn;
export declare class FloatValidator implements ValidatorInterface {
    protected formatter: NumberFormatter;
    constructor(formatter: NumberFormatter);
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<FloatValidator, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<FloatValidator>;
}
