...
export declare const dateTimeValidator: (formatter: DatetimeFormatter) => StandardValidatorFn;
export declare class DateTimeValidator implements ValidatorInterface {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<DateTimeValidator, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<DateTimeValidator>;
}
//# sourceMappingURL=datetime.validator.d.ts.map