...
export declare const dateValidator: (formatter: DateFormatter, userFormat: string) => StandardValidatorFn;
export declare class DateValidator implements ValidatorInterface {
    protected formatter: DateFormatter;
    protected utils: FormControlUtils;
    constructor(formatter: DateFormatter, utils: FormControlUtils);
    ...
    static ɵprov: i0.ɵɵInjectableDeclaration<DateValidator>;
}
