...
export declare const currencyValidator: (formatter: NumberFormatter) => StandardValidatorFn;
export declare class CurrencyValidator implements ValidatorInterface {
    ...
    static ɵprov: i0.ɵɵInjectableDeclaration<CurrencyValidator>;
}
//# sourceMappingURL=currency.validator.d.ts.map