...
import { ButtonGroupInterface, DropdownButtonInterface, AnyButtonInterface } from 'common';
...
export declare class ButtonGroupComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ButtonGroupComponent, "scrm-button-group", never, { "config$": { "alias": "config$"; "required": false; }; "klass": { "alias": "klass"; "required": false; }; }, {}, never, never, false, never>;
}
export {};
