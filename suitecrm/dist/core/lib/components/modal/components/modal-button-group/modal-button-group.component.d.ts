...
export declare class ModalButtonGroupComponent implements OnInit {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<ModalButtonGroupComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ModalButtonGroupComponent, "scrm-modal-button-group", never, { "config$": { "alias": "config$"; "required": false; }; "activeModal": { "alias": "activeModal"; "required": false; }; }, {}, never, never, false, never>;
}
