...
export declare class ChartComponent implements OnInit {
    protected registry: ChartRegistry;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ChartComponent, "scrm-chart", never, { "dataSource": { "alias": "dataSource"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, false, never>;
}
