...
export declare class BaseChartComponent {
    ...
    height: number;
    view: import("@angular/core").WritableSignal<number[]>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BaseChartComponent, "ng-component", never, { "dataSource": { "alias": "dataSource"; "required": false; }; }, {}, never, never, false, never>;
}
