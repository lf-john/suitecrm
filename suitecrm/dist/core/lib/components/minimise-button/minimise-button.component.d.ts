...
export declare class MinimiseButtonComponent implements OnInit, OnChanges {
    ...
    toggleStatus(): void;
    getIcon(): string;
    static ɵfac: i0.ɵɵFactoryDeclaration<MinimiseButtonComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<MinimiseButtonComponent, "scrm-minimise-button", never, { "config": { "alias": "config"; "required": false; }; "status": { "alias": "status"; "required": false; }; }, {}, never, never, false, never>;
}
