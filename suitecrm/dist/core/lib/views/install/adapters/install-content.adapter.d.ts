...
export declare class InstallContentAdapter implements RecordContentDataSource {
    protected store: InstallViewStore;
    protected metadata: MetadataStore;
    protected language: LanguageStore;
    protected actions: InstallActionManager;
    inlineEdit: true;
    constructor(store: InstallViewStore, metadata: MetadataStore, language: LanguageStore, actions: InstallActionManager);
    getEditAction(): void;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<InstallContentAdapter, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<InstallContentAdapter>;
}
//# sourceMappingURL=install-content.adapter.d.ts.map