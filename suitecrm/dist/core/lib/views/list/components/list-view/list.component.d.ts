...
export declare class ListComponent implements OnInit, OnDestroy {
    ...
    constructor(appState: AppStateStore, listStore: ListViewStore, quickFilters: QuickFiltersService, sidebarWidgetHandler: ListViewSidebarWidgetService);
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<ListComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ListComponent, "scrm-list", never, {}, {}, never, never, false, never>;
}
