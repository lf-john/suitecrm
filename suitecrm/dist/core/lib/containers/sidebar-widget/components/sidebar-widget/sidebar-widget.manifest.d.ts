...
export declare const sidebarWidgetModules: (typeof ChartSidebarWidgetModule)[];
export declare const componentTypeMap: {
    'history-timeline': typeof HistorySidebarWidgetComponent;
    chart: typeof ChartSidebarWidgetComponent;
    statistics: typeof StatisticsSidebarWidgetComponent;
    'record-thread': typeof RecordThreadSidebarWidgetComponent;
};
//# sourceMappingURL=sidebar-widget.manifest.d.ts.map