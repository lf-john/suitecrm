...
export declare abstract class RecordThreadItemActionHandler extends ActionHandler<RecordThreadItemActionData> {
     ...
     * @param record
     */
    protected navigateBack(navigation: ModuleNavigation, params: {
        [p: string]: string;
    }, id: string, moduleName: string, record: Record): void;
}
//# sourceMappingURL=record-thread-item.action.d.ts.map