...
class __TwigTemplate_0941c71f034db0013107aa620f9b9686 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["authenticationError"] ?? null)) {
            // line 8
            yield "<p>";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(($context["authenticationError"] ?? null), ($context["authenticationErrorData"] ?? null), "SchebTwoFactorBundle"), "html", null, true);
            yield "</p>
";
        }
        // line 10
...
";
        ...
        yield " ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["twoFactorProvider"] ?? null), "html", null, true);
        yield ":</label></p>

<form class=\"form\" action=\"";
        // line 23
        ((($context["checkPathUrl"] ?? null)) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["checkPathUrl"] ?? null), "html", null, true)) : (yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath(($context["checkPathRoute"] ?? null))));
        yield "\" method=\"post\">
    <p class=\"widget\">
        <input
            id=\"_auth_code\"
            ...
            name=\"";
        // line 28
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["authCodeParameterName"] ?? null), "html", null, true);
        yield "\"
    ...
    ";
        ...
        if (($context["displayTrustedOption"] ?? null)) {
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["trustedParameterName"] ?? null), "html", null, true);
            yield "\" /> ";
    ...
    ";
        ...
        if (($context["isCsrfProtectionEnabled"] ?? null)) {
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["csrfParameterName"] ?? null), "html", null, true);
            yield "\" value=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(($context["csrfTokenId"] ?? null)), "html", null, true);
            yield "\">
    ";
        }
        // line 46
...
";
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["logoutPath"] ?? null), "html", null, true);
        yield "\">";
...
";
    ...
    {
        return array (  136 => 50,  129 => 46,  121 => 44,  118 => 43,  110 => 41,  108 => 40,  103 => 37,  97 => 28,  89 => 23,  81 => 21,  78 => 19,  74 => 17,  63 => 15,  59 => 14,  54 => 13,  52 => 12,  49 => 10,  43 => 8,  41 => 7,  38 => 5,);
    }
