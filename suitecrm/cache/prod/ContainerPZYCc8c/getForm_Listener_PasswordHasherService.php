...
class getForm_Listener_PasswordHasherService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/Extension/PasswordHasher/EventListener/PasswordHasherListener.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/password-hasher/Hasher/UserPasswordHasherInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/password-hasher/Hasher/UserPasswordHasher.php';
