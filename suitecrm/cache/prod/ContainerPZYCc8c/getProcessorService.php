...
class getProcessorService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Symfony/Messenger/DispatchTrait.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Symfony/Messenger/Processor.php';
