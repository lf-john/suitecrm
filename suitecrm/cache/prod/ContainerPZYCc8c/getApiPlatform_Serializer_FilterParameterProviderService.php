...
class getApiPlatform_Serializer_FilterParameterProviderService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/State/ParameterProviderInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Serializer/Parameter/SerializerFilterParameterProvider.php';
