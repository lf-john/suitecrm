...
class getForm_RegistryService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/FormRegistryInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/FormRegistry.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/FormExtensionInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/Extension/DependencyInjection/DependencyInjectionExtension.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/ResolvedFormTypeFactoryInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/ResolvedFormTypeFactory.php';
