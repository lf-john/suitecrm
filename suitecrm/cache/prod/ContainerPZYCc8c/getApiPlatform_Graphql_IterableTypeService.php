...
class getApiPlatform_Graphql_IterableTypeService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/webonyx/graphql-php/src/Type/Definition/NamedTypeImplementation.php';
        ...
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/GraphQl/Type/Definition/IterableType.php';
