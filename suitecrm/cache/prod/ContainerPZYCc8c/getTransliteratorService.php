...
class getTransliteratorService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/vich/uploader-bundle/src/Util/Transliterator.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/string/Slugger/SluggerInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/string/Slugger/AsciiSlugger.php';
