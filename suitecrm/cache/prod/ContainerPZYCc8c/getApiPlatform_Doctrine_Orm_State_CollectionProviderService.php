...
class getApiPlatform_Doctrine_Orm_State_CollectionProviderService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Doctrine/Common/State/LinksHandlerLocatorTrait.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Doctrine/Common/State/LinksHandlerTrait.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Doctrine/Orm/State/LinksHandlerTrait.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Doctrine/Orm/State/CollectionProvider.php';
