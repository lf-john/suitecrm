...
class get_Messenger_HandlerDescriptor_VMw0m61Service extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/notifier/Messenger/MessageHandler.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/notifier/Transport/TransportInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/notifier/Transport/Transports.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/notifier/Transport.php';
