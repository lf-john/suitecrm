...
class getTwigService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/twig-bridge/Extension/SerializerExtension.php';
        ...
        include_once \dirname(__DIR__, 3).'/vendor/doctrine/doctrine-bundle/src/Twig/DoctrineExtension.php';
        ...
        include_once \dirname(__DIR__, 3).'/vendor/vich/uploader-bundle/src/Twig/Extension/UploaderExtension.php';
        ...
        $a->addPath((\dirname(__DIR__, 3).'/vendor/symfony/security-bundle/Resources/views'), '!Security');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/doctrine/doctrine-bundle/templates'), 'Doctrine');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/doctrine/doctrine-bundle/templates'), '!Doctrine');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/doctrine/doctrine-migrations-bundle/Resources/views'), 'DoctrineMigrations');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/doctrine/doctrine-migrations-bundle/Resources/views'), '!DoctrineMigrations');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/api-platform/core/src/Symfony/Bundle/Resources/views'), 'ApiPlatform');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/api-platform/core/src/Symfony/Bundle/Resources/views'), '!ApiPlatform');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/scheb/2fa-bundle/Resources/views'), 'SchebTwoFactor');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/scheb/2fa-bundle/Resources/views'), '!SchebTwoFactor');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/vich/uploader-bundle/templates'), 'VichUploader');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/vich/uploader-bundle/templates'), '!VichUploader');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/symfony/twig-bridge/Resources/views/Email'), 'email');
        $a->addPath((\dirname(__DIR__, 3).'/vendor/symfony/twig-bridge/Resources/views/Email'), '!email');
