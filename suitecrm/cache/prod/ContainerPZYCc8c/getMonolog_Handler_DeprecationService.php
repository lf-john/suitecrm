...
class getMonolog_Handler_DeprecationService extends App_KernelProdContainer
{
    ...
    {
        $container->privates['monolog.handler.deprecation'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/logs/prod/prod.deprecations.log'), $container->getEnv('DEPRECATION_LOG_LEVEL'), true, NULL, false);
