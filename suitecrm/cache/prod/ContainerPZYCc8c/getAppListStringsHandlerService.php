...
class getAppListStringsHandlerService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/core/backend/Languages/LegacyHandler/AppListStringsProviderInterface.php';
        include_once \dirname(__DIR__, 3).'/core/backend/Languages/LegacyHandler/AppListStringsHandler.php';
