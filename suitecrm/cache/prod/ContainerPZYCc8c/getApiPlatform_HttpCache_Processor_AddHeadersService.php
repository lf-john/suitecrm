...
class getApiPlatform_HttpCache_Processor_AddHeadersService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/HttpCache/State/AddHeadersProcessor.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/State/Processor/AddLinkHeaderProcessor.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/State/Util/CorsTrait.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Hydra/State/HydraLinkProcessor.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/State/Processor/RespondProcessor.php';
