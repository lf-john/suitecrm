...
class getSerializer_Mapping_CacheWarmerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/framework-bundle/CacheWarmer/AbstractPhpFileCacheWarmer.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/framework-bundle/CacheWarmer/SerializerCacheWarmer.php';
