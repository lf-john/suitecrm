...
class getTwig_Runtime_HttpkernelService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/twig-bridge/Extension/HttpKernelRuntime.php';
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/http-foundation/UriSigner.php';
