...
class getDoctrine_UuidGeneratorService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/doctrine/orm/src/Id/AbstractIdGenerator.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/doctrine-bridge/IdGenerator/UuidGenerator.php';
