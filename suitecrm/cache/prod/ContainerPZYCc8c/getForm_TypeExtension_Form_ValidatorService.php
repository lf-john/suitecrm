...
class getForm_TypeExtension_Form_ValidatorService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/Extension/Validator/Type/BaseValidatorExtension.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/Extension/Validator/Type/FormTypeValidatorExtension.php';
