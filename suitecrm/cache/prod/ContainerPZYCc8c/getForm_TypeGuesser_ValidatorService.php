...
class getForm_TypeGuesser_ValidatorService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/FormTypeGuesserInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/form/Extension/Validator/ValidatorTypeGuesser.php';
